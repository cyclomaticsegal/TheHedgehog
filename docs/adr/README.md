...
This directory contains Architecture Decision Records (ADRs) for The Hedgehog.
...
| [0017](0017-commodity-bias-eval-and-cross-model-judge.md) | Commodity Bias Evaluation and Cross-Model Judge | Accepted | 2026-04-14 |
| [0018](0018-dag-visualization-wry-d3-webview.md) | DAG Visualization via wry + D3 WebView | Accepted | 2026-04-14 |
| [0019](0019-dexter-51folds-integration-and-inline-report.md) | Dexter `/51folds` Integration and Inline Report | Accepted | 2026-04-14 |
| [0020](0020-fanning-out-51folds-model-builds-concurrent-tray.md) | Fan-out 51Folds Model Builds — Concurrent Tray and File Logging | Accepted | 2026-04-16 |
